...
<main>
  ...
  <section class="history sections clearfix">
    <div class="inner">
      ...
      <ul class="column02">
        <li>
          <p class="event"><span>■</span>2006年4月商業施設「オリナスモール（徒歩3分）」「オリナスコア（徒歩3分）」オープン</p>
        </li>
        <li>
      ...
      <p class="event red"><span>■</span>2023年度錦糸町駅前「放射第32号線（錦糸町Ⅰ期）」拡幅事業開始</p>
      ...
      <div class="shops">
        ...
        <ul class="column03">
          <li>
            ...
            <p class="name">カスミフードスクエアオリナス錦糸町店</p>
