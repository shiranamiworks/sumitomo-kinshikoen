...
<main>
  ...
  <header class="main-visual clearfix">
    ...
    <figure><img src="./images/concept/mv02-pc.jpg" alt="" class="w_100 pc"><p class="annotation white">image photo</p></figure>
    <figure><img src="./images/concept/mv03-pc.jpg" alt="" class="w_100 pc"><p class="annotation white">image photo</p></figure>
  ...
  <div class="top-mv__slide sp tb">
    ...
    <figure><img src="./images/concept/mv02-sp.jpg" alt="" class="w_100 pc"><p class="annotation white">image photo</p></figure>
    <figure><img src="./images/concept/mv03-sp.jpg" alt="" class="w_100 pc"><p class="annotation white">image photo</p></figure>
    ...
    <div class="inner">
      <ul class="clearfix">
        ...
        <li>
          ...
          <p class="name">「大手町」駅直通<span class="num">13</span>分</span></p>
          <p class="lead">生まれ変わった美しい都市空間の一画に、<br>「錦糸町」で約12年ぶりとなる大規模分譲マンションが誕生する。<br><br>あなたがここで出逢うのは、躍動する都心を自在に駆けるアクセスと、<br>オリナス錦糸町（約240m）や錦糸公園（約210m）を間近に、<br>都市の利便と自然の潤いに心から満たされるライフスタイル。<br><br>足を延ばせば、さらなる恩恵との出逢いに溢れ、<br>彩り豊かな時間が輝きを増していく。<br><br>「シティタワー錦糸公園」全130邸。<br>リバーサイドの爽やかな風の中に、今、求めていた暮らしの舞台を。</p>
        </li>
      </ul>
      </div>
