...
<main>
    ...
    <div class="inner">
      ...
      <ul class="column03">
        ...
        <li>
          ...
          <p class="caps">③ オリナス錦糸町（約240m／徒歩3分）</p>
  ...
  <div class="inner01">
    <p class="txt">東京メトロ半蔵門線「錦糸町」駅<br class="sp">（徒歩8分）より</p>
  ...
  <section class="box sections clearfix">
    <div class="inner">
      <ul class="column02">
        ...
        <li>
          <p class="txt">東京メトロ有楽町線の延伸計画によって、<br class="pc">豊洲方面へのアクセス利便が向上。</p>
  ...
  <section class="sections car clearfix">
    <div class="inner">
      ...
      <div class="infos info02">
        <p class="txt01">JR「錦糸町」駅前には、羽田空港行きのスカイツリーシャトル<sup>&reg;</sup>が発着。</p>
        <p class="txt02">JR「錦糸町」駅南口 <br class="sp">スカイツリーシャトル<sup>&reg;</sup>乗り場 <br class="sp"><span>（約850m／徒歩11分）</span></p>
        <ul class="column02">
          <li>
            <div class="image">
